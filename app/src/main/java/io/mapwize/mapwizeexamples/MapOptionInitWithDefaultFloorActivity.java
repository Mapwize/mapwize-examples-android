 ...
 * The goal here is to demonstrate how to initialize your map on a specific floor in a Venue
 * You can can check the MapOptionCenteredOnVenue first if you want to know more about centeredOnVenue option usage
 */

public class MapOptionInitWithDefaultFloorActivity extends AppCompatActivity {
    ...
    static final Double MAPWIZE_DEFAULT_FLOOR = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_option_init_with_default_floor);
