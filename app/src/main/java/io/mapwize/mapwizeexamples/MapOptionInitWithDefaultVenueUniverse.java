 ...
 * The goal here is to demonstrate how to initialize your map in a specific Venue Universe
 * You can can check the MapOptionCenteredOnVenue first if you want to know more about centeredOnVenue option usage
 */

public class MapOptionInitWithDefaultVenueUniverse extends AppCompatActivity {
    ...
    static final String MAPWIZE_UNIVERSE_ID = "58eb79f01cb35c00105f4a9e";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_option_init_with_default_venue_universe);
